...
\author{Student names and student numbers here} 
...
%Source code files (for multiple files use a new lstinputlisting environment each time):
\lstinputlisting{ArgonSimulation.py} %No quotes around filenames
\lstinputlisting{main_argon.py}
%...
